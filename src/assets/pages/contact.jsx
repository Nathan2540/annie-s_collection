...
<ul class="wrapper">
  ...
  <a href="https://www.instagram.com/itzannie_bby?igsh=MTUycjh5ZWxzbzQxaA%3D%3D&utm_source=qr">
...
<Flex flexDirection={"column"} width={"100%"} justifyContent={"center"} alignItems={"center"}>
    <Text fontSize={"29px"}>
        ...
        <Text fontSize={"15px"}>Describe what you want and we'll get it for you</Text>
<form
  action="https://formspree.io/f/xyzwwdza"
  method="POST"
>
  <label className="label">
    Your email:
    <input type="email" name="email" className="input1"></input>
  </label>
  <br />
  <label className="label">
    Your Message/Description:
    <textarea name="message" className="input2"></textarea>
  </label>
  <br />
